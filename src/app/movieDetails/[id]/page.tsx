...
export default function MovieDetails() {
    ...
    return (
        <Box sx={{ padding: "1rem", display: "flex", flexDirection: "column", gap: "2rem", minHeight: "100vh" }}>
            <Grid sx={{ display: "flex", flexDirection: { xl: "row", md: "row", sm: "row", xs: "column" }, justifyContent: { xl: "space-between", md: "center", xs: "center" }, gap: "1rem" }}>
                <Card sx={{ display: "flex", flexDirection: "column", justifyContent: "center", width: { xl: "60rem", sm: "120rem", md: "120rem" }, height: { xl: "33rem" }, borderWidth: "3px", borderStyle: "solid", borderRadius: "0rem", padding: "0.25rem", backgroundColor: theme.palette.primary.main, borderColor: theme.palette.primary.main }}>
